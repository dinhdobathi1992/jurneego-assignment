...
5. **Enhanced safety model** — dedicated content moderation model (e.g., AWS Comprehend or a fine-tuned classifier) rather than just keyword lists
6. **Flag dashboard UI** — a simple React/Next.js teacher portal to review flags without needing to call the API directly
